<?php
    /**
    * @version advisories.php 2009-07-15 $
    * @copyright Copyright (C) peachtree. All rights reserved.
    *
    * @author Amol Divalkar
    * @Modified By 
    * @version 1.0 
    * @desc This is main file (advisories) which is used to render advisories page for the project
    */
    ...
    $strLmenu = $hldGlobal->fnMenu("advisory",$arrMpage);//Fetches left menu
    ...
    $strMidPage = $hldGlobal->fnGetMiddlePage(0,$intCid,$strSearchTxt,"advisory");
    $hdlTpl->setVariable("middle_page",$strMidPage);//Assigns mid page
    
    /*$arrPages = $hldGlobal->fnGetPages("advisory");
