<?php
    /**
    * @version changepstatus.php 2009-07-15 $
    * @copyright Copyright (C) IRCS.com. All rights reserved.
    *
    * @author Amol Divalkar
    * @Modified By 
    * @version 1.0 
    * @desc This is main file (changepstatus) which is used to change the status of the file
    */
    ...
    $sqlChange = "UPDATE tblpages SET isactive='".$_GET["activeflg"]."' WHERE id='".$_GET["id"]."'";
