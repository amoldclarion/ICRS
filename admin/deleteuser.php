<?php
    /**
    * @version deleteuser.php 2009-06-10 $
    * @copyright Copyright (C) peachtreecardiovascular.com. All rights reserved.
    *
    * @author Amol Divalkar
    * @Modified By 
    * @version 1.0 
    * @desc This is main file (deleteuser) which is used to delete user from our records
    */
    ...
    $sqlChange = "DELETE FROM tbluser WHERE id='".$_GET["id"]."'";
