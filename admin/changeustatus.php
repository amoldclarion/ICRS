<?php
    /**
    * @version changeustatus.php 2009-07-14 $
    * @copyright Copyright (C) IRCS.com. All rights reserved.
    *
    * @author Amol Divalkar
    * @Modified By 
    * @version 1.0 
    * @desc This is main file (changeustatus) which is used to change the status of the user
    */
    ...
    $sqlChange = "UPDATE tbluser SET isactive='".$_GET["activeflg"]."' WHERE id='".$_GET["id"]."'";
