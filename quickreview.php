<?php
    /**
    * @version quickreview.php 2009-07-15 $
    ...
    */
    ...
    $strLmenu = $hldGlobal->fnMenu("quick_review",$arrMpage);//Fetches left menu
    ...
    $strMidPage = $hldGlobal->fnGetMiddlePage(0,$intCid,$strSearchTxt,"quick_review");
    $hdlTpl->setVariable("middle_page",$strMidPage);//Assigns mid page
    
    /*$arrPages = $hldGlobal->fnGetPages("quick_review");
