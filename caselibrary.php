<?php
    /**
    * @version caselibrary.php 2009-07-15 $
    * @copyright Copyright (C) peachtree. All rights reserved.
    * AMol is here
    * @author Amol Divalkar
    * @Modified By 
    * @version 1.0 
    * @desc This is main file (caselibrary) which is used to render caselibrary page for the project
    */
    ...
    $strLmenu = $hldGlobal->fnMenu("case_library",$arrMpage);//Fetches left menu
    ...
    $strMidPage = $hldGlobal->fnGetMiddlePage(0,$intCid,$strSearchTxt,"case_library");
    $hdlTpl->setVariable("middle_page",$strMidPage);//Assigns mid page
    
    /*$arrPages = $hldGlobal->fnGetPages("case_library");
